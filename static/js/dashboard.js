...
const _SETTINGS_FIELDS = {
    ...
    int: ['MEMORY_PALACE_DEFAULT_LIMIT', 'CACHE_PARTITION_X', 'CACHE_PARTITION_EXTRACT_LIMIT', 'CACHE_PARTITION_WINDOW', 'EMBEDDING_DIM'],
    float: [],
    optionalFloat: ['CHAT_TEMPERATURE'],
    bool: ['MEMORY_ENABLED', 'KEYWORD_CONTEXT_ENABLED', 'CACHE_PARTITION_ENABLED', 'CACHE_PARTITION_KEEP_A_TOOLS', 'TOOL_CHAIN_DEBUG', 'FORCE_STREAM', 'RESPONSE_TRANSFORM_ENABLED'],
    range: [],
