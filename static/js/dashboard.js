...
const _SETTINGS_FIELDS = {
    ...
    bool: ['MEMORY_ENABLED', 'KEYWORD_CONTEXT_ENABLED', 'CONTEXT_TEMPLATE_ENABLED', 'CACHE_PARTITION_ENABLED', 'CACHE_PARTITION_KEEP_A_TOOLS', 'TOOL_CHAIN_DEBUG', 'FORCE_STREAM', 'PERF_DIAGNOSTIC_ENABLED', 'RESPONSE_TRANSFORM_ENABLED'],
    range: [],
