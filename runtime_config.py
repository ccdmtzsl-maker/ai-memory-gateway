...
class RuntimeConfig:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            "cfg.API_BASE_URL": self.API_BASE_URL,
            "cfg.API_KEY": self.API_KEY,
            "cfg.DEFAULT_MODEL": self.DEFAULT_MODEL,
            "cfg.CHAT_TEMPERATURE": self.CHAT_TEMPERATURE,
            "cfg.REASONING_EFFORT": self.REASONING_EFFORT,
            "cfg.FORCE_STREAM": self.FORCE_STREAM,
            "cfg.MEMORY_ENABLED": self.MEMORY_ENABLED,
            "cfg.MEMORY_API_KEY": self.MEMORY_API_KEY,
            "cfg.MEMORY_API_BASE_URL": self.MEMORY_API_BASE_URL,
            "cfg.MEMORY_PALACE_DEFAULT_LIMIT": self.MEMORY_PALACE_DEFAULT_LIMIT,
            "cfg.MEMORY_PALACE_INJECTION_DEPTH": self.MEMORY_PALACE_INJECTION_DEPTH,
            "cfg.CACHE_PARTITION_ENABLED": self.CACHE_PARTITION_ENABLED,
            "cfg.CACHE_PARTITION_X": self.CACHE_PARTITION_X,
            "cfg.CACHE_PARTITION_B_LIMIT": self.CACHE_PARTITION_B_LIMIT,
            "cfg.CACHE_PARTITION_EXTRACT_LIMIT": self.CACHE_PARTITION_EXTRACT_LIMIT,
            "cfg.CACHE_PARTITION_TRIGGER": self.CACHE_PARTITION_TRIGGER,
            "cfg.CACHE_PARTITION_WINDOW": self.CACHE_PARTITION_WINDOW,
            "cfg.CACHE_PARTITION_KEEP_A_TOOLS": self.CACHE_PARTITION_KEEP_A_TOOLS,
            "cfg.CACHE_SUMMARY_MODEL": self.CACHE_SUMMARY_MODEL,
            "cfg.KEYWORD_CONTEXT_ENABLED": self.KEYWORD_CONTEXT_ENABLED,
            "cfg.KEYWORD_CONTEXT_RULES": self.KEYWORD_CONTEXT_RULES,
            "cfg.CONTEXT_TEMPLATE_ENABLED": self.CONTEXT_TEMPLATE_ENABLED,
            "cfg.CONTEXT_TEMPLATE": self.CONTEXT_TEMPLATE,
            "cfg.SPARSE_TIMESTAMP_ENABLED": self.SPARSE_TIMESTAMP_ENABLED,
            "cfg.USER_NICKNAME": self.USER_NICKNAME,
            "cfg.CHARACTER_NAME": self.CHARACTER_NAME,
            "cfg.TOOL_CHAIN_DEBUG": self.TOOL_CHAIN_DEBUG,
            "cfg.PERF_DIAGNOSTIC_ENABLED": self.PERF_DIAGNOSTIC_ENABLED,
            "cfg.RESPONSE_TRANSFORM_ENABLED": self.RESPONSE_TRANSFORM_ENABLED,
            "cfg.RESPONSE_TRANSFORM_RULES": self.RESPONSE_TRANSFORM_RULES,
        }
